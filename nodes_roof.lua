...
cottages.register_roof = function( name, description, tiles, basic_material, homedecor_alternative )
   ...
   minetest.register_node("cottages:roof_" .. name .. "_corner_inner", {
		...
		tiles = {	tiles[1], 
				tiles[2], 
				tiles[3],
				tiles[2] .. "^[resize:64x64^(" .. tiles[6] .. "^[transformFX^cottages_corner_inner_mask.png^[transformFX^[makealpha:255,255,255)",
				tiles[5], 
				tiles[2] .. "^[resize:64x64^(" .. tiles[6] .. "^cottages_corner_inner_mask.png^[makealpha:255,255,255)" },
		paramtype = "light",
		paramtype2 = "facedir",
		groups = {snappy = 2, choppy = 2, oddly_breakable_by_hand = 2, roof = 1},
		node_box = {
